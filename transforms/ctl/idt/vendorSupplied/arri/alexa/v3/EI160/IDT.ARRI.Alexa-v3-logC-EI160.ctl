...
// <ACEStransformID>IDT.ARRI.Alexa-v3-logC-EI160.a1.v1</ACEStransformID>
// <ACESuserName>ACES 1.0 Input - ARRI V3 LogC (EI160)</ACESuserName>
...
normalizedLogCToRelativeExposure(float x) {
	if (x > 0.125266)
		return (pow(10,(x - 0.381991) / 0.269035) - 0.080216) / 5.555556;
	else
		return (x - 0.092778) / 5.842031;
}
