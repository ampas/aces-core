...
// <ACEStransformID>IDT.ARRI.Alexa-v3-logC-EI200.a1.v1</ACEStransformID>
// <ACESuserName>ACES 1.0 Input - ARRI V3 LogC (EI200)</ACESuserName>
...
normalizedLogCToRelativeExposure(float x) {
	if (x > 0.128643)
		return (pow(10,(x - 0.382478) / 0.266007) - 0.076620) / 5.555556;
	else
		return (x - 0.092782) / 5.776260;
}
