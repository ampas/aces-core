...
// <ACEStransformID>IDT.ARRI.Alexa-v3-logC-EI500.a1.v1</ACEStransformID>
// <ACESuserName>ACES 1.0 Input - ARRI V3 LogC (EI500)</ACESuserName>
...
normalizedLogCToRelativeExposure(float x) {
	if (x > 0.142526)
		return (pow(10,(x - 0.384493) / 0.253569) - 0.060939) / 5.555556;
	else
		return (x - 0.092800) / 5.506183;
}
