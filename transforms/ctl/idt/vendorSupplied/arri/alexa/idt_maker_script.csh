...
foreach v (2 3)
	...
	foreach wb (${wbs})
		python v${v}_IDT_maker.py ${ei} ${wb} raw > ${root}/v${v}/EI${ei}/IDT.ARRI.Alexa-raw-EI${ei}-CCT${wb}.a1.v${v}.ctl
		if (${v} == 3) then
		    python v${v}_IDT_maker.py ${ei} ${wb} raw nd1pt3 > ${root}/v${v}/EI${ei}/IDT.ARRI.Alexa-raw-EI${ei}-CCT${wb}-ND1pt3.a1.v${v}.ctl
		endif
	end
	if ($v == 2) then
	    # V2 LogC was still CCT-dependent
	    foreach wb (${wbs})
		python v2_IDT_maker.py ${ei} ${wb} logc > ${root}/v2/EI${ei}/IDT.ARRI.Alexa-logC-EI${ei}-CCT${wb}.a1.v2.ctl
	    end
	else
	    ...
	    python v3_IDT_maker.py ${ei} ignore_this logc > ${root}/v3/EI${ei}/IDT.ARRI.Alexa-logC-EI${ei}.a1.v3.ctl
	endif
    end
end
