...
// 
// Summary :
//  This transform is intended for mapping OCES onto the SMPTE Reference 
//  Projector. The assumed observer adapted white is D60, and the viewing 
//  environment is that of a dark theater. 
//
