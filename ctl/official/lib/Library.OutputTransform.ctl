...
// Table generation
const Chromaticities REACH_PRI = AP1;   // equal to ACES "AP1" primaries
...
//     print( "panlrcm:\n" );
//     print_f33( transpose_f33( panlrcm));
...
{ 
    ...
    // Reach cusps at maxJ
    const float REACH_TABLE[gamutTableSize] = make_gamut_reach_table( REACH_PRI, 
                                                                      PARAMS.limitJmax, 
                                                                      peakLuminance );
