...
ACEScc and ACESproxy image data is **NOT** intended to be written out to image files. See the ACEScc and ACESproxy documentation for more information.
  ...
  * **InvOCES/**
    * *SonyF35.StillLife_from_ODT.Academy.DCDM_P3D60.exr* - `InvODT.Academy.DCDM.ctl` applied to *ODT/SonyF35.StillLife_ODT.Academy.DCDM_P3D60.tiff*
    * *SonyF35.StillLife_from_ODT.Academy.DCDM.exr* - `InvODT.Academy.DCDM.ctl` applied to *ODT/SonyF35.StillLife_ODT.Academy.DCDM.tiff*
    * *SonyF35.StillLife_from_ODT.Academy.P3D60_48nits.exr* - `InvODT.Academy.P3D60_48nits.ctl` applied to *ODT/SonyF35.StillLife_ODT.Academy.P3D60_48nits.tiff*
  ...
  * **ODT/**
    * *SonyF35.StillLife_ODT.Academy.DCDM_P3D60.tiff* - `ODT.Academy.DCDM_P3D60.ctl` applied to *OCES/SonyF35.StillLife.exr*
