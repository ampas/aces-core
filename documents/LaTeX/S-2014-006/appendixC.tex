...
%Element:
%\begin{xmlfields}
%    \xmlitem[IndexMap][required] A LUT3D can have one or three IndexMaps. If there are three IndexMaps, they are in the RGB order. If only one IndexMap is present, it is applied to all three color components. (see IndexMap element below for more details)
%
%\end{xmlfields}
% 
%1DLUT
