...
\definecolor{teal}{rgb}{0, 0.5600, 0.66}
...
%   morecomment=[s]{<?}{?>},
  ...
  identifierstyle=\bfseries\color{orange},
  keywordstyle=\color{teal},
  morekeywords={xmlns, id, name, compCLFversion, inverseOf, inBitDepth, outBitDepth, style, rawHalfs, halfDomain, dim, interpolation, base, logSideSlope, logSideOffset, linSideSlope, linSideOffset, linSideBreak, linearSlope, linearOffset, exponent, offset, channel, version, encoding,  type, minOccurs, maxOccurs, use, abstract, substitutionGroup, default, value}% list your attributes here
}
...
\begin{appendices}
    \input{appendix-schema.tex}
    \input{appendix-interpolation.tex}    
    \input{appendix-cineonlog.tex}    
    \input{appendix-changes.tex}
\end{appendices}
